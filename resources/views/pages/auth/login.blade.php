    ...
    <div class="min-h-[calc(100vh-200px)] flex items-center justify-center py-12">
        <div class="w-full max-w-md">
            ...
            <div class="card p-8" x-data="{ sessionExpired: new URLSearchParams(window.location.search).has('session_expired'), error: new URLSearchParams(window.location.search).get('error') }">
                ...
                <div class="space-y-3">
                    {{-- Keycloak SSO Login --}}
                    <a href="/api/auth/oauth/keycloak/redirect" class="flex items-center justify-center gap-3 w-full py-3 px-4 bg-primary-600 text-white rounded-lg hover:bg-primary-700 font-medium transition-colors">
                    ...
                    <div class="relative my-4">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white text-neutral-500">또는</span>
                        </div>
                    </div>
